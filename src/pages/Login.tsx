...
const Login = () => {
  ...
  const handleGoogleLogin = () => {
    ...
    const email = prompt("Enter your email for mock login (use lolerodiez@gmail.com for admin)", "lolerodiez@gmail.com");
    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/30 px-4 py-12">
      <Card className="w-full max-w-md">
        ...
        <CardContent className="grid gap-4">
          <Button onClick={handleGoogleLogin} variant="outline" size="lg" className="flex gap-2 items-center">
